...
// 			//outlog << "At line no: " << lines << " func_definition : " << $1->get_name() << " " << $2->get_name() << "(" << $4->get_name() << ")" << endl << endl;
...
// 		}
	func_definition : type_specifier ID LPAREN parameter_list RPAREN compound_statement
	{
		...
		// Log the function definition
		outlog << "At line no: " << lines << " func_definition : " << $1->get_name() << " " << $2->get_name() << "(" << $4->get_name() << ")" << endl << endl;

		// Exit the scope after the function definition
		sym_table->exit_scope();
		outlog << "Scopetable with ID " << sym_table->getCurrentScopeID() + 1 << " removed" << endl << endl;
	}
...
int main(int argc, char *argv[])
{
	...
	yyin = fopen(argv[1], "r");
	outlog.open("20201120_output.txt", ios::trunc);
